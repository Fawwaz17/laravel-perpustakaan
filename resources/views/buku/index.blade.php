		...
		<div class="row">
			<div class="table-responsive">
				...
				<tr>
					...
					<td>
						<a href="/perpus/{{$bukus->id}}/edit" class="btn btn-warning btn-sm" style="color: white">Edit</a>
						<a href="/perpus/{{$bukus->id}}/delete" class="btn btn-danger btn-sm" style="color: white">Delete</a>
					</td>
				</tr>
				@endforeach
			</table>
				...
				<div class="modal fade" id="exampleModalScrollable" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
				  <div class="modal-dialog modal-dialog-scrollable" role="document">
				    <div class="modal-content">
				      ...
				      <form action="/perpus/create" method="POST">
				      	{{ csrf_field() }}
					      <div class="modal-body">
					      	<!-- form -->
						        <div class="form-group row" style="margin-left: 10%">
								    ...
								    <div class="col-sm-10" style="margin-top: 5%">
								      <input name="tahun_terbit" required="required" type="text" class="form-control" id="tahun_terbit" placeholder="Tahun Terbit">
								    </div>
